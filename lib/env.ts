...
const envSchema = z.object({
  ...
  LESSON_RETENTION_DAYS: z.coerce.number().int().min(1).max(365).default(30),
  MANIM_RENDERER_URL: z.string().url().optional(),
  MANIM_RENDERER_API_KEY: z.string().min(1).optional(),
  IMAGE_VIDEO_RENDERER_URL: z.string().url().optional(),
  IMAGE_VIDEO_RENDERER_API_KEY: z.string().min(1).optional(),
