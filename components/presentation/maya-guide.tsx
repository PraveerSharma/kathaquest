...
export function MayaGuide({
  ...
  const blinkPhase = frame % 92;
  const eyeScale = blinkPhase > 84 && blinkPhase < 89 ? 0.12 : 1;
  const sparkle = 0.55 + Math.sin(frame / 9) * 0.35;
  ...
  return (
    <div
      style={{
        ...
        transform: `translateY(${interpolate(entrance, [0, 1], [80, bob])}px) scale(${interpolate(entrance, [0, 1], [0.65, breathe])})`,
      }}
    >
      <svg
        ...
        width="280"
      >
        <ellipse cx="120" cy="286" fill="#342A54" opacity=".16" rx="84" ry="13" />
        <g opacity={sparkle}>
          <path d="m31 72 5 11 11 5-11 5-5 11-5-11-11-5 11-5 5-11Z" fill="#F3B742" />
          <path d="m207 118 4 8 8 4-8 4-4 8-4-8-8-4 8-4 4-8Z" fill="#FF775F" />
        </g>
        ...
        <path
          ...
          strokeWidth="18"
          style={{
            transform: `rotate(${expression === "excited" ? Math.sin(frame / 8) * 5 - 8 : 0}deg)`,
            transformOrigin: "52px 203px",
          }}
        />
        <path
          d="m188 203 26 39"
